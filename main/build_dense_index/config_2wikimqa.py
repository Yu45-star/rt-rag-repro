...
save_path = "data/embeddings/2wikimqa/200_2_2"
...
# Dataset name used by the retrieval pipeline
dataset_name = "2wikimqa"

# Raw corpus filename used to build the dense index (without .json extension)
raw_file_name = "2wikimultihopqa"
